...
public class MapTask extends AsyncTask<Map, Integer, String> {
    ...
    protected void onPostExecute(String s) {
        ...
        // gson이 역직렬화하는 코드
        com.material.components.kosbank.MembersVO mem = gson.fromJson(s, com.material.components.kosbank.MembersVO.class);
        Log.d("JSON_RESULT", mem.getId());
        Log.d("JSON_RESULT", mem.getPw());
    }
}
