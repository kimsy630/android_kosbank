...
public class HttpClient {
    ...
    public static class Builder {
        ...
        public com.material.components.kosbank.HttpClient create() {
            com.material.components.kosbank.HttpClient client = new com.material.components.kosbank.HttpClient();
